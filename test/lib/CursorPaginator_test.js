var CursorPaginator = require('../../lib/CursorPaginator');

describe('CursorPaginator', function() {
    beforeEach(function() {
        this.id = '/my-resources';
        this.items = [0, 1, 2];
        this.expires = 1000;
        this.paginator = new CursorPaginator(this.id, this.items, this.expires);
    });
    ...
    describe('nextCursor', function() {
        ...
        it('can be cleared', function() {
            this.paginator.setNextCursor('abc123');
            this.paginator.getNextCursor().should.equal('abc123');
            this.paginator.setNextCursor(undefined);
            expect(this.paginator.getNextCursor()).to.be.undefined;
        });
    });
    ...
    describe('stringification', function() {
        ...
        it('does not contain nextCursor property if not specified', function() {
            this.objectify().should.not.have.property('nextCursor');
        });

        it('contains nextCursor property if set', function() {
            this.paginator.setNextCursor('abc123');
            this.objectify().should.have.property('nextCursor', 'abc123');
        });
