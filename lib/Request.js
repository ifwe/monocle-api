...
Request.ERROR_PROPS_NOT_FOUND = {
    ...
    message: 'Following props do not exist in schema'
}
...
Request.prototype.error = function(httpStatusCode, message, errorCode, errorString, propertyErrors) {
    return this.status(httpStatusCode, {
        code: errorCode || Request.ERROR_UNKNOWN.code,
        error: errorString || Request.ERROR_UNKNOWN.error,
        message: message || Request.ERROR_UNKNOWN.message,
