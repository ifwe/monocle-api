...
Request.prototype.setUrl = function(url) {
    ...
    // @ts-ignore TODO: this will fail for props of string[]
 ...
 *
 * @param {number} code - HTTP status code (can also be a stringified number)
 * @param {any} body - Option response body
 */
Request.prototype.status = function(code, body) {
    body = body || {};
    // @ts-ignore complaining about coercing possible stringified number
