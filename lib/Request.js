...
Request.prototype.error = function(httpStatusCode, errorObject, propertyErrors) {
    ...
    return this.status(httpStatusCode, {
        code: errorObject.code || Request.ERROR_UNKNOWN.code,
        error: errorObject.error || Request.ERROR_UNKNOWN.error,
        message: errorObject.message || Request.ERROR_UNKNOWN.message,
