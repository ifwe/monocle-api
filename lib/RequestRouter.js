...
RequestRouter.prototype.error = function(httpStatusCode, message, errorCode, errorString) {
    return this._request.error(httpStatusCode, message, errorCode, errorString, this._propertyErrors);
};
...
RequestRouter.prototype.propertyError = function(property, errorCode, httpStatusCode, message) {
    ...
    return this.error(httpStatusCode, this._request.ERROR_SCHEMA.code, this._request.ERROR_SCHEMA.error, message || this._request.ERROR_SCHEMA.message + ' ' + property);
};
