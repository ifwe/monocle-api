...
Router.prototype.handle = function(request, connection) {
    ...
    .then(function(results) {
        ...
        if (result.$internalError == 'missing') {
            ...
            return requestRouter.error(404, RequestRouter.ERROR_PROPS_NOT_FOUND.message +': '+ result.unfound, RequestRouter.ERROR_PROPS_NOT_FOUND.code, RequestRouter.ERROR_PROPS_NOT_FOUND.error);
        }
